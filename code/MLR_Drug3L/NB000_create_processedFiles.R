...
pMat = getMatrixFromArrow(ArrowFile = paste0(out_dir,"MLR_drug_filtered_annotated/ArrowFiles/MLR_5um_homeTn5.arrow"),
                          ArchRProj = prj, 
...
gMat = getMatrixFromArrow(ArrowFile = paste0(out_dir,"MLR_drug_filtered_annotated/ArrowFiles/MLR_5um_homeTn5.arrow"),
                          ArchRProj = prj, 
